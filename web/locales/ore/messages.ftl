...
aae = Kanien’kéha Edu/Careful Speech Set
aan = Kanien’kéha Natural Speech Set
ab = Abkhaz
ace = Acehnese
ady = Adyghe
af = Afrikaans
...
mn = Mongolian
mni = Meetei Lon
mok = Kanien’kéha (Kahnawa’kéha)
moo = Kanyen'kéha (Ohswekèn:'a)
mos = Mossi
mr = Marathi
mrj = Hill Mari
ms = Malay
...
record-instruction = { $actionType }<recordIcon></recordIcon> <educationalPrompt></educationalPrompt>
record-stop-instruction = { $actionType }<stopIcon></stopIcon> when done
record-three-more-instruction = { $actionType }<recordIcon></recordIcon> <educationalPrompt></educationalPrompt>
record-again-instruction = { $actionType }<recordIcon></recordIcon> <educationalPrompt></educationalPrompt>
record-again-instruction2 = { $actionType }<recordIcon></recordIcon> <educationalPrompt></educationalPrompt>
record-last-instruction = { $actionType }<recordIcon></recordIcon> <educationalPrompt></educationalPrompt>
